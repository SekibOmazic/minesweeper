...
Elm.Minesweeper.make = function (_elm) {
   ...
   var drawButton = function (gameState) {
      return function () {
         var msg = $Text.height(24)($Text.color($Color.white)($Text.fromString("Click to restart")));
         var png = function () {
            switch (gameState.ctor)
            {case "Lost":
               return "images/face/oh.png";
               case "Won":
               return "images/face/victory.png";}
            return "images/face/defeat.png";
         }();
         var buttonWithText = A2($Graphics$Element.flow,
         $Graphics$Element.right,
         _L.fromArray([A3($Graphics$Element.image,
                      32,
                      32,
                      png)
                      ,$Graphics$Element.width(330)($Graphics$Element.rightAligned(msg))]));
         var header = $Graphics$Element.color($Color.purple)(A3($Graphics$Element.container,
         384,
         48,
         $Graphics$Element.middle)(buttonWithText));
      ...
      return function () {
         ...
         {case "_Tuple2":
            return function () {
                 switch (_v45.ctor)
                 {case "_Tuple4":
                    return $Graphics$Element.color($Color.lightGrey)(A3($Graphics$Element.container,
                      _v46._0,
                      _v46._1,
            ...
            return function () {
                 ...
                 {case "Click":
                    switch (action._0.ctor)
                      {case "_Tuple2":
                         return function () {
                              var restCells = safeClicks(_v55._1);
