         ...
         var clearedCell = function () {
            ...
            {case "Mine":
               ...
               return square(A2($Basics._op["++"],
                 "/images/cell/",
                 A2($Basics._op["++"],
                 $Basics.toString(_v41._0),
                 ".png")));}
            _U.badCase($moduleName,
            "between lines 217 and 221");
         }();
         return function () {
            var _v43 = cell.state;
            switch (_v43.ctor)
   ...
   _v44) {
      return function () {
         ...
         {case "_Tuple4":
            return A2($Graphics$Element.flow,
              $Graphics$Element.down,
              _L.fromArray([drawButton(_v44._0)
                           ,A3(drawBoard,
                           config,
                           _v44._1,
                           _v44._2)]));}
            ...
            return function () {
                 ...
                 {case "Click":
                    switch (action._0.ctor)
                      {case "_Tuple2":
                         return function () {
                              var restCells = safeClicks(_v50._1);
